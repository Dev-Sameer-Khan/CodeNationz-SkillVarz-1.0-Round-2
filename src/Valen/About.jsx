...
const About = () => {
  ...
  const boxDet = [
    { name: "Client", work: "Valantina Wonderkin" },
    { name: "Industry", work: "Fashion" },
    { name: " Services", work: "Modeling" },
    { name: " Year", work: "2025" },
  ];
  return (
    <div className="max-[599px]:h-[100vh] max-[1024px]:min-h-[70vh] h-[130vh] relative flex items-center  justify-center bg-center">
      <div className="w-full h-full overflow-hidden z-10">
        <img
          ...
          src="https://res.cloudinary.com/dbgzq41x2/image/upload/v1745601729/Rectangle_10_1_ekmabg.png"
          alt=""
        />
      </div>
