...
const About = () => {
  ...
  gsap.registerPlugin(ScrollTrigger);
   useEffect(()=>{
    ...
    const boxDet=[{name:"Client",work:"Natural Space"},{name:"Industry",work:"NGC"},{name:" Services",work:"Safe Space"},{name:" Year",work:"2025"},]
  return (
...
<img className=' move w-full h-full object-cover scale-150' src="https://res.cloudinary.com/dbgzq41x2/image/upload/v1745601400/Rectangle_10_hkjgl5.png" alt="" />
</div>
        ...
        <h1 className='font-[sloop] text-white max-[599px]:text-4xl max-[1024px]:text-6xl text-8xl'>Feeling of nature</h1></div>
