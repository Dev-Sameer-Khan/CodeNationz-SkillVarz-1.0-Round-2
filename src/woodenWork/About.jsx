...
const About = () => {
  ...
  const boxDet = [
    { name: "Client", work: "Wooden Works" },
    { name: "Industry", work: " Furniture" },
    { name: " Services", work: "Sales" },
    { name: " Year", work: "2025" },
  ];
  return (
    <div className="max-[599px]:h-[100vh] max-[1024px]:min-h-[70vh] h-[130vh] relative flex items-center  justify-center bg-center">
      <div className="w-full h-full overflow-hidden z-10">
        <img
          ...
          src="https://res.cloudinary.com/dbgzq41x2/image/upload/v1745477813/bgImg3_ruyokv.jpg"
          alt=""
        />
      </div>
