...
<img className=' move w-full h-full object-cover scale-150' src="https://res.cloudinary.com/dbgzq41x2/image/upload/v1745477813/bgImg3_ruyokv.jpg" alt="" />
</div>
        <div  className= "max-[599px]:w-[90%] flex max-[559px]:mb-30 z-20 items-center justify-center absolute bg-[url(https://res.cloudinary.com/dbgzq41x2/image/upload/v1745477814/bgImg2_dy1joz.png)] w-[67%] bg-cover bg-center  max-[599px]:h-[60vw] h-[37vw]">
        <h1 className='font-[sloop] text-white max-[599px]:text-4xl max-[1024px]:text-6xl text-8xl'>Furniture - Lifetime for all</h1></div>
