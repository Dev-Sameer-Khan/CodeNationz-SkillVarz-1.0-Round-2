...
mm.add("(max-width: 799px)", () => {
  ...
  return (
    <div className="screen min-h-screen max-[599px]:min-h-[200vh] max-[599px]:px-8 max-[599px]:py-10 relative flex-col flex max-[599px]:gap-y-10 gap-y-25 items-center justify-center overflow-hidden">
      <img className="w-full h-full max-[599px]:h-screen object-cover move scale-150 max-[599px]:scale-200 -mt-40" src="https://res.cloudinary.com/dbgzq41x2/image/upload/v1745477814/bgImg4_glfixq.png" alt="" />
