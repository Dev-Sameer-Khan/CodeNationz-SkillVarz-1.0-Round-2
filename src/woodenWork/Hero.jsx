...
const Hero = () => {
  return (
    <div className=' max-[599px]:min-h-[60vh] min-h-screen flex  bg-[#d9d9d9]'>
        ...
        <div className=' max-[599px]:hidden block  max-[1024px]:w-[100%] w-[50%] bg-[url("https://res.cloudinary.com/dbgzq41x2/image/upload/v1745431512/work2_mwosrs.png")] bg-cover bg-center'> </div>
    </div>
  )
}
